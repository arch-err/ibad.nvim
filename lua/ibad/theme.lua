...
if vim.g.ibad_italic_keywords then
	italic_keywords = true
end

if vim.g.ibad_italic_functions then
	italic_functions = true
end

if vim.g.ibad_italic_comments then
	italic_comments = true
end

if vim.g.ibad_italic_loops then
	italic_loops = true
end

if vim.g.ibad_italic_conditionals then
...
theme.set_highlights = function()
	...
	hl(0, "CursorLineNr", { fg = c.active_cyan, bg = "NONE", bold = true })
	...
	hl(0, "Visual", { fg = "NONE", bg = c.alt_lighter_bg })
	...
	-- Code
	hl(0, "Comment", { fg = c.dark_gray, bg = "NONE", italic = italic_comments })
	...
	hl(0, "DiagnosticUnderlineHint", { fg = "NONE", bg = "NONE", sp = "NONE", undercurl = true })
	hl(0, "DiagnosticUnderlineInfo", { fg = "NONE", bg = "NONE", sp = "NONE", undercurl = true })
	hl(0, "DiagnosticUnderlineWarn", { fg = "NONE", bg = "NONE", sp = "NONE", undercurl = true })
	hl(0, "DiagnosticUnderlineError", { fg = "NONE", bg = "NONE", sp = "NONE", undercurl = true })
	...
	-- Telescope
	hl(0, "TelescopeSelection", { fg = "NONE", bg = c.cursor_bg })
	hl(0, "TelescopeSelectionCaret", { fg = c.red, bg = c.cursor_bg })
	hl(0, "TelescopeMatching", { fg = c.red, bg = "NONE", bold = true, italic = true })
	hl(0, "TelescopeBorder", { fg = c.gray, bg = "NONE" })
	hl(0, "TelescopeNormal", { fg = c.fg, bg = "NONE" })
	hl(0, "TelescopePromptTitle", { fg = c.green, bg = "NONE" })
	hl(0, "TelescopePromptPrefix", { fg = c.hint, bg = "NONE" })
	hl(0, "TelescopeResultsTitle", { fg = c.green, bg = "NONE" })
	hl(0, "TelescopePreviewTitle", { fg = c.green, bg = "NONE" })
	hl(0, "TelescopePromptCounter", { fg = c.gray, bg = "NONE" })
	hl(0, "TelescopePreviewHyphen", { fg = c.gray, bg = "NONE" })
	...
	-- StatusLine
	hl(0, "StatusLine", { fg = c.context, bg = "NONE" })
